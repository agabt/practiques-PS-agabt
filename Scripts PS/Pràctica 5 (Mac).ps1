...
function login([bool]$log, [string]$user_f) {
    ...
    if ($log) {
        ...
        Write-Output "Inici de sessió correcte del usuari $user_f a l'hora $date" >> '/Users/anthony/Documentos/Code/practiques-PS-agabt/Scripts PS/Texts/AGT_Logins.txt'
        ...
        Write-Output "Prova d'inici de sessió incorrecta del usuari $user_f a l'hora $date" >> '/Users/anthony/Documentos/Code/practiques-PS-agabt/Scripts PS/Texts/AGT_Logins.txt'
    }
}
